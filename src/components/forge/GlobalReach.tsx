...
const indiaFillPoints = [
  ...
  { lat: 12.97, lng: 77.6 },  // Bangalore
  { lat: 17.4, lng: 78.5 },   // Hyderabad
  { lat: 23.0, lng: 72.6 },   // Ahmedabad
  { lat: 26.9, lng: 75.8 },   // Jaipur
  { lat: 15.4, lng: 73.9 },   // Goa
  { lat: 25.3, lng: 83.0 },   // Varanasi
  { lat: 11.0, lng: 76.9 },   // Coimbatore
  { lat: 30.7, lng: 76.8 },   // Chandigarh
  { lat: 21.2, lng: 81.1 },   // Raipur
  { lat: 23.3, lng: 85.3 },   // Ranchi
  { lat: 26.5, lng: 80.3 },   // Kanpur
  { lat: 9.9, lng: 76.3 },    // Kochi
  { lat: 22.3, lng: 73.2 },   // Vadodara
  { lat: 18.5, lng: 73.9 },   // Pune
  { lat: 24.6, lng: 73.7 },   // Udaipur
  { lat: 32.7, lng: 74.9 },   // Jammu
];
...
function CountryMarkers({ radius }: { radius: number }) {
  ...
  const markerGeometry = useMemo(() => {
    ...
    allPoints.forEach((point, i) => {
      ...
      // Larger dots for named countries, smaller for fill

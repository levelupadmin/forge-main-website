...
export default function ClosingCTA() {
  ...
  return (
    <section style={{ background: '#FFFFFF', padding: isMobile ? '80px 24px' : '120px 80px', textAlign: 'center' }}>
      <div ref={ref} style={{ maxWidth: 800, margin: '0 auto', opacity: isVisible ? 1 : 0, transform: isVisible ? 'translateY(0)' : 'translateY(28px)', transition: 'opacity 650ms ease, transform 650ms ease' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: 14, flexWrap: 'wrap' }}>
          <button onClick={scrollToRoles}
            style={{ background: '#222222', color: '#FFFFFF', borderRadius: 100, padding: '16px 40px', fontFamily: "'Open Sauce One', sans-serif", fontSize: 16, fontWeight: 700, border: 'none', cursor: 'pointer', transition: 'all 250ms ease' }}
            ...
            onMouseLeave={e => { e.currentTarget.style.background = '#222222'; e.currentTarget.style.color = '#FFFFFF'; e.currentTarget.style.transform = 'translateY(0)'; }}
